...
export function apply(ctx) {
  ...
  // extraRoots feeds the Studio install found on this machine into the shared
  // candidate list, so non-default DevEco locations resolve without env vars.
  const extraSdkRoots = () => {
    const st = getStudio()
    return st.ok ? [joinPath(st.root, 'sdk')] : []
  }
