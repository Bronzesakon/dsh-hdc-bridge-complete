...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function PanelSurface(props) {
      ...
      var collapsePair = React.useState(false);
      var shotHidden = shotPair[0], setShotHidden = shotPair[1];
      var collapsed = collapsePair[0], setCollapsed = collapsePair[1];
      ...
      return React.createElement('div', { className: 'hdcp-panel', role: 'dialog', 'aria-label': '鸿蒙开发面板' },
        React.createElement('div', { className: 'hdcp-card' },
          React.createElement('div', { className: 'hdcp-head' },
            ...
            React.createElement('button', { type: 'button', className: 'hdcp-btn', onClick: function () { setCollapsed(function (value) { return !value; }); } }, collapsed ? '展开' : '收起'),
            React.createElement('button', { type: 'button', className: 'hdcp-btn', onClick: props.onClose, title: '关闭' }, '×')
          ),
          collapsed ? null : React.createElement('div', { className: 'hdcp-tools' }, React.createElement('span', { className: 'hdcp-tools-label' }, '本地工具链'), badges),
          collapsed ? null : React.createElement('div', { className: 'hdcp-body' }, body)
        )
      );
    }
